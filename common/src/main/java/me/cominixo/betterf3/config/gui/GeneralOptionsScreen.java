...
public final class GeneralOptionsScreen {
    ...
    public static ConfigBuilder configBuilder(final Minecraft minecraft) {
        ...
        final ConfigCategory general =
                builder.getOrCreateCategory(Component.translatable("config.betterf3.title.general"));

        general.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("config.betterf3.disable"), GeneralOptions.disableMod)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("config.betterf3.auto_start"), GeneralOptions.autoF3)
                .setDefaultValue(false)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.space_modules"), GeneralOptions.spaceEveryModule)
                .setDefaultValue(false)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.performance_optimizations"),
                        GeneralOptions.enablePerformanceOptimizations)
                .setDefaultValue(true)
                .setTooltip(Component.translatable("config.betterf3.performance_optimizations.tooltip"))
                .setSaveConsumer(newValue -> GeneralOptions.enablePerformanceOptimizations = newValue)
                .build());

        general.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("config.betterf3.shadow_text"), GeneralOptions.shadowText)
                .setDefaultValue(true)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.animations"), GeneralOptions.enableAnimations)
                .setDefaultValue(true)
        ...
        general.addEntry(entryBuilder
                .startDoubleField(
                        Component.translatable("config.betterf3.animationSpeed"), GeneralOptions.animationSpeed)
                .setDefaultValue(1)
                .setMin(1)
                .setMax(3)
        ...
        general.addEntry(entryBuilder
                .startDoubleField(Component.translatable("config.betterf3.fontScale"), GeneralOptions.fontScale)
                .setDefaultValue(1)
                .setMin(0.1)
                .setMax(2)
        ...
        general.addEntry(entryBuilder
                .startColorField(
                        Component.translatable("config.betterf3.color.background"), GeneralOptions.backgroundColor)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.debug_crosshair"), GeneralOptions.hideDebugCrosshair)
                .setDefaultValue(false)
                .setTooltip(Component.translatable("config.betterf3.debug_crosshair.tooltip"))
                .setSaveConsumer(newValue -> {
                    GeneralOptions.hideDebugCrosshair = newValue;
                    if (minecraft.level != null && !GeneralOptions.disableMod && newValue) {
                        minecraft.debugEntries.setStatus(
                                DebugScreenEntries.THREE_DIMENSIONAL_CROSSHAIR, DebugScreenEntryStatus.NEVER);
                    }
                })
                .build());

        general.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("config.betterf3.sidebar"), GeneralOptions.hideSidebar)
                .setDefaultValue(true)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("config.betterf3.bossbar"), GeneralOptions.hideBossbar)
                .setDefaultValue(true)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.always_enable_profiler"),
                        GeneralOptions.alwaysEnableProfiler)
                .setDefaultValue(false)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.always_enable_tps_graph"),
                        GeneralOptions.alwaysEnableTPS)
                .setDefaultValue(false)
        ...
        general.addEntry(entryBuilder
                .startBooleanToggle(
                        Component.translatable("config.betterf3.always_enable_ping_graph"),
                        GeneralOptions.alwaysEnablePing)
                .setDefaultValue(false)
