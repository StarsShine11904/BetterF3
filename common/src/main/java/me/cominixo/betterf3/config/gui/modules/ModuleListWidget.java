...
public class ModuleListWidget extends ObjectSelectionList<ModuleListWidget.ModuleEntry> {
    ...
    public class ModuleEntry extends Entry<ModuleEntry> {
        ...
        public boolean mouseClicked(final MouseButtonEvent mouseButtonEvent, final boolean a) {
            Objects.requireNonNull(this.modulesScreen.modulesListWidget);
            ...
            final double e = mouseY
                    - ModuleListWidget.this.getRowTop(
                            ModuleListWidget.this.children().indexOf(this));
            if (d <= 32.0D) {
        ...
        public void extractContent(
            ...
            context.text(this.client.font, this.module.toString(), x + 35, y + 1, 0xffffffff, true);

            final Component exampleText;

            if (this.module instanceof CoordsModule coordsModule) {
                Objects.requireNonNull(coordsModule.nameColor);

                exampleText = Utils.styledText("X", coordsModule.colorX)
                        .append(Utils.styledText("Y", coordsModule.colorY))
                        .append(Utils.styledText("Z", coordsModule.colorZ))
                        .append(Utils.styledText(": ", coordsModule.nameColor))
                        .append(Utils.styledText("100 ", coordsModule.colorX)
                                .append(Utils.styledText("200 ", coordsModule.colorY))
                                .append(Utils.styledText("300", coordsModule.colorZ)));

            } else if (this.module instanceof FpsModule fpsModule) {
                exampleText = Utils.styledText("60 fps  ", fpsModule.colorHigh)
                        .append(Utils.styledText("40 fps  ", fpsModule.colorMed))
                        .append(Utils.styledText("10 fps", fpsModule.colorLow));
            } else {
                exampleText = Utils.styledText("Name: ", this.module.nameColor)
                        .append(Utils.styledText("Value", this.module.valueColor));
            }
            ...
            if (hovered) {
                ...
                if (index > 0) {
                    if (v < 16 && w < 16) {
                        context.blitSprite(
                                ...
                                Identifier.parse("server_list/move_up_highlighted"),
                                x,
                                y,
                                32,
                                32);
                        ...
                        context.blitSprite(
                                RenderPipelines.GUI_TEXTURED, Identifier.parse("server_list/move_up"), x, y, 32, 32);
                    }
                }
                ...
                if (index < ModuleListWidget.this.moduleEntries.size() - 1) {
                    if (v < 16 && w > 16) {
                        context.blitSprite(
                                RenderPipelines.GUI_TEXTURED,
                                Identifier.parse("server_list/move_down_highlighted"),
                                x,
                                y,
                                32,
                                32);
                        ...
                        context.blitSprite(
                                RenderPipelines.GUI_TEXTURED, Identifier.parse("server_list/move_down"), x, y, 32, 32);
                    }
                }
            }
        }
